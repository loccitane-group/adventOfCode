...
test('Sum of Game Ids should be 2285', () => {
    ...
    expect(sumOfGameIds(gameIds)).toBe(2285)
})
...
test('find possible games with constraints and 5 games', () => {
    ...
    expect(findPossibleGames(gameRecords, configuration)).toEqual(['Game 1', 'Game 2', 'Game 5'])
})

test('find possible games with constraints and 1 game', () => {
    const gameRecords = `Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green`
   
    expect(findPossibleGames(gameRecords, configuration)).toEqual(['Game 1'])
})

test('find possible games with constraints and 6 games', () => {
    const gameRecords = `Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
    Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
    Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
    Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
    Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green
    Game 6: 20 red, 1 blue, 3 green; 2 blue, 1 red, 2 green`
    
    expect(findPossibleGames(gameRecords, configuration)).toEqual(['Game 1', 'Game 2', 'Game 5'])
})

test('find possible games with constraints and 100 games', () => {
    const gameRecords = `Game 1: 4 green, 7 blue; 2 blue, 4 red; 5 blue, 2 green, 2 red; 1 green, 3 red, 9 blue; 3 green, 9 blue; 7 green, 2 blue, 2 red
    ...
    expect(findPossibleGames(gameRecords, configuration)).toEqual([
        "Game 1",
        "Game 2",
        "Game 4",
        "Game 7",
...
test('sum of powers of 5 games', () => {
    expect(sumOfPowers([48, 12, 1560, 630, 36])).toEqual(2286)
})

test('find minimum set of cubes with 5 games', () => {
    const gameRecords = `Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
    Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
    Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
    Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
    ...
    expect(findMinimumSetOfCubes(gameRecords)).toEqual([48, 12, 1560, 630, 36])
})

test('sum of powers of 100 games', () => {
    expect(sumOfPowers([
        252,
        72,
        1260,
...
test('find minimum set of cubes with 100 games', () => {
    const gameRecords = `Game 1: 4 green, 7 blue; 2 blue, 4 red; 5 blue, 2 green, 2 red; 1 green, 3 red, 9 blue; 3 green, 9 blue; 7 green, 2 blue, 2 red
    Game 2: 1 blue, 2 red; 1 green, 2 blue, 1 red; 1 red, 5 green; 3 red, 2 blue, 8 green; 3 blue, 2 red, 4 green; 2 blue, 4 green, 3 red
    Game 3: 7 red, 7 blue, 9 green; 15 green, 4 red, 8 blue; 3 green, 12 blue, 6 red
    Game 4: 4 blue, 11 green, 6 red; 4 green, 2 red; 12 red, 1 blue, 3 green
    ...
    expect(findMinimumSetOfCubes(gameRecords)).toEqual([
        252,
        72,
        1260,
        528,
