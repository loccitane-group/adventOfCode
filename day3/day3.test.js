...
test('8 numbers should be part numbers on 10 numbers', () => {
...
test('test with 119 numbers', () => {
    ...
    expect(partNumbers.map(x => x.value)).toEqual([
        ...
        332,
        306, 212, 879, 725,
        2, 529, 914, 256, 840, 5, 882, 40, 653, 681, 984, 944, 884, 959, 76, 867, 419, 765, 516, 410, 481, 463, 71,
        501, 895, 178, 433, 137, 658, 672, 216, 478, 660, 590, 193, 851, 85, 939, 320, 227,
        548, 309, 758, 524, 653, 588, 58, 494,
        291, 97, 231, 932, 457, 905, 942, 267, 214, 816, 5, 614, 180, 60, 308, 397, 67, 805, 178, 542,
        671, 574, 559, 551, 370, 322, 210, 51, 803, 360, 679, 421, 378, 51, 344, 606, 564
    ])
})
...
`
    ...
    expect(sumOfPartNumbers).toBe(12830)
})
...
`
    ...
    const sumGearRatios = sum(gearsRatio)
    expect(sumGearRatios).toBe(467835)
})


test('find gears from input', () => {
    const engineSchematic = `
    ....937..........309.............191..............745.................913......................................256................891.......
    ................*..................-..113.......3*..............219.........495%................40....97.......*.......670.60..../..........
    ......919..928..511......................................%......#...&...................................*.................*.................
...
`
    ...
    const gearsRatio = findGearsRatio(engineSchematic)
    const sumGearRatios = sum(gearsRatio)
    expect(sumGearRatios).toBe(84051670)
})