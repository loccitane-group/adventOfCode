...
test('part 2 example', () => {
    ...
    const commonShortestPathSteps = commonShortestPath(
        stepsPerPath(
            directions,
            network,
            findStartingNodes(network),
            findEndingNodes(network))
        )
...
test('part 2', () => {
    const maps = `
